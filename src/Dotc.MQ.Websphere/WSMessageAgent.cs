...
{
    public sealed class WsMessageAgent : IDisposable
    {
        ...
        public WsMessageAgent(MQQueueManager queueManager)
        {
        ...
        public PcfMessage NewRequest(int command)
        {
        ...
        public bool TrySend(PcfMessage request, out PcfMessage[] result, bool skipNextOnFailure = false)
        {
            LastError = null;
        ...
        public bool TrySend(PcfMessage request, bool skipNextOnFailure = false)
        {
            LastError = null;
